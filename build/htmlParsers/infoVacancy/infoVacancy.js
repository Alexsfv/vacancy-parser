...
var InfoVacancyParser = /** @class */ (function () {
    function InfoVacancyParser() {
        var _this = this;
        this.parseVacancy = function ($) {
            var vacancy = $('.main-content')[0];
            if (!vacancy)
                throw ("vacancy not found!");
            return {
                logoUrl: _this.vacancyLogo($(vacancy))
            };
        };
        this.vacancyLogo = function (vacancy) {
    ...
    return InfoVacancyParser;
}());
exports["default"] = InfoVacancyParser;
